---
layout: article
title:  "数字图像算法—图像二值化 JavaScript实现"
author: "pengchen"
date:   2017-01-12
...
二值化方法：
       首先将图片进行灰度化（灰度化算法写在这里[数字图像算法——256色转灰度图 JavaScript实现](/blog/2017/01/11/01.html)，这里采用平均值法），然后设置一个阈值，大于这个值就设置成255，小于就设置成0；

效果图：


![数字图像算法——图像二值化 JavaScript实现](https://cdn.files.qdfuns.com/article/content/picture/201701/12/112231znc4wfa847nfggr4.png)
